package com.avatarduels.project.addons.ability.fire;
...
public class FireDisc extends FireAbility implements AddonAbility {
	...
	public FireDisc(Player player) {
		...
		this.damage = AvatarDuels.instance.getConfig().getDouble("Abilities.Fire.FireDisc.Damage");
		this.range = AvatarDuels.instance.getConfig().getDouble("Abilities.Fire.FireDisc.Range");
		this.control = AvatarDuels.instance.getConfig().getBoolean("Abilities.Fire.FireDisc.Controllable");
		this.revert = AvatarDuels.instance.getConfig().getBoolean("Abilities.Fire.FireDisc.RevertCutBlocks");
		this.drop = AvatarDuels.instance.getConfig().getBoolean("Abilities.Fire.FireDisc.DropCutBlocks");
		this.cooldown = AvatarDuels.instance.getConfig().getLong("Abilities.Fire.FireDisc.Cooldown");
		this.knockback = AvatarDuels.instance.getConfig().getDouble("Abilities.Fire.FireDisc.Knockback");
	...
	public boolean cutBlock(Block b) {
		return AvatarDuels.instance.getConfig().getStringList("Abilities.Fire.FireDisc.CuttableBlocks").contains(b.getType().toString());
	}
	...
	public boolean isEnabled() {
		return AvatarDuels.instance.getConfig().getBoolean("Abilities.Fire.FireDisc.Enabled");
	}
