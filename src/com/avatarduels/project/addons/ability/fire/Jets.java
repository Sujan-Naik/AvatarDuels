...
public class Jets extends FireAbility implements AddonAbility {
	...
	public Jets(Player player, TurboJet source) {
		...
		this.maxHeight = AvatarDuels.instance.getConfig().getInt("Abilities.Fire.Jets.MaxHeight");
		...
		this.flySpeed = AvatarDuels.instance.getConfig().getDouble("Abilities.Fire.Jets.FlySpeed");
		this.hoverSpeed = AvatarDuels.instance.getConfig().getDouble("Abilities.Fire.Jets.HoverSpeed");
		this.duration = AvatarDuels.instance.getConfig().getLong("Abilities.Fire.Jets.Duration");
		this.maxCooldown = AvatarDuels.instance.getConfig().getLong("Abilities.Fire.Jets.Cooldown.Maximum");
		this.minCooldown = AvatarDuels.instance.getConfig().getLong("Abilities.Fire.Jets.Cooldown.Minimum");
		this.dmgThreshold = player.getHealth() - AvatarDuels.instance.getConfig().getDouble("Abilities.Fire.Jets.DamageThreshold");
		double speedThreshold = AvatarDuels.instance.getConfig().getDouble("Abilities.Fire.Jets.SpeedThreshold");
	...
	public boolean isEnabled() {
		return AvatarDuels.instance.getConfig().getBoolean("Abilities.Fire.Jets.Enabled");
	}
