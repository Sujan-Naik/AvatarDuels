...
public class TurboJet extends FireAbility implements AddonAbility, ComboAbility {
	...
	public TurboJet(Player player) {
		...
		this.speed = AvatarDuels.instance.getConfig().getDouble("Combos.Fire.TurboJet.Speed");
		this.cooldown = AvatarDuels.instance.getConfig().getLong("Combos.Fire.TurboJet.Cooldown");
		this.normal = AvatarDuels.instance.getConfig().getDouble("Abilities.Fire.Jets.FlySpeed");
	...
	public boolean isEnabled() {
		return AvatarDuels.instance.getConfig().getBoolean("Combos.Fire.TurboJet.Enabled");
	}
}
