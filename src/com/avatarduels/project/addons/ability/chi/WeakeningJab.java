...
public class WeakeningJab extends ChiAbility implements ComboAbility, AddonAbility{
	...
	public WeakeningJab(Player player) {
		...
		duration = AvatarDuels.instance.getConfig().getLong("Combos.Chi.WeakeningJab.Duration");
		cooldown = AvatarDuels.instance.getConfig().getLong("Combos.Chi.WeakeningJab.Cooldown");
	...
	public boolean isEnabled() {
		return AvatarDuels.instance.getConfig().getBoolean("Combos.Chi.WeakeningJab.Enabled");
	}
	...
	public static double getModifier() {
		return AvatarDuels.instance.getConfig().getDouble("Combos.Chi.WeakeningJab.Modifier");
	}
}
