...
public class ChiblockJab extends ChiAbility implements ComboAbility, AddonAbility{
	...
	public ChiblockJab(Player player) {
		...
		duration = AvatarDuels.instance.getConfig().getLong("Combos.Chi.ChiblockJab.Duration");
		cooldown = AvatarDuels.instance.getConfig().getLong("Combos.Chi.ChiblockJab.Cooldown");
	...
	public boolean isEnabled() {
		return AvatarDuels.instance.getConfig().getBoolean("Combos.Chi.ChiblockJab.Enabled");
	}
}
