...
public class Tailwind extends AirAbility implements ComboAbility, AddonAbility {
	...
	public Tailwind(Player player) {
		...
		cooldown = AvatarDuels.instance.getConfig().getLong("Combos.Air.Tailwind.Cooldown");
		duration = AvatarDuels.instance.getConfig().getLong("Combos.Air.Tailwind.Duration");
		speed = AvatarDuels.instance.getConfig().getInt("Combos.Air.Tailwind.Speed") - 1;
	...
	public boolean isEnabled() {
		return AvatarDuels.instance.getConfig().getBoolean("Combos.Air.Tailwind.Enabled");
	}
