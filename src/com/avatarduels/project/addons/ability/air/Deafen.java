...
import com.avatarduels.project.addons.util.SoundAbility;
...
public class Deafen extends SoundAbility implements AddonAbility {
	...
	public Deafen(Player player) {
		...
		this.duration = AvatarDuels.instance.getConfig().getLong("Abilities.Air.Deafen.Duration");
		this.cooldown = AvatarDuels.instance.getConfig().getLong("Abilities.Air.Deafen.Cooldown");
	...
	public boolean isEnabled() {
		return AvatarDuels.instance.getConfig().getBoolean("Abilities.Air.Deafen.Enabled");
	}
}
