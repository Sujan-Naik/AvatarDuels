package com.avatarduels.project.addons.ability.air;
...
public class FlightPassive extends FlightAbility implements AddonAbility, PassiveAbility {
	...
	public FlightPassive(Player player) {
		...
		flySpeed = (float) AvatarDuels.instance.getConfig().getDouble("Passives.Air.Flying.FlySpeed");
		speed = startSpeed = (float) AvatarDuels.instance.getConfig().getDouble("Passives.Air.Flying.Glide.StartSpeed");
		maxSpeed = (float) AvatarDuels.instance.getConfig().getDouble("Passives.Air.Flying.Glide.MaxSpeed");
		acceleration = (float) AvatarDuels.instance.getConfig().getDouble("Passives.Air.Flying.Acceleration");
	...
	public boolean isEnabled() {
		return AvatarDuels.instance.getConfig().getBoolean("Passives.Air.Flying.Enabled");
	}
