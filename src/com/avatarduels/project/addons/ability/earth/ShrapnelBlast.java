...
public class ShrapnelBlast extends MetalAbility implements AddonAbility {
	...
	public ShrapnelBlast(Player player) {
		...
		int shots = AvatarDuels.instance.getConfig().getInt("Abilities.Earth.Shrapnel.Blast.Shots");
		int spread = AvatarDuels.instance.getConfig().getInt("Abilities.Earth.Shrapnel.Blast.Spread");
		long cooldown = AvatarDuels.instance.getConfig().getLong("Abilities.Earth.Shrapnel.Blast.Cooldown");
		double speed = AvatarDuels.instance.getConfig().getDouble("Abilities.Earth.Shrapnel.Blast.Speed");
