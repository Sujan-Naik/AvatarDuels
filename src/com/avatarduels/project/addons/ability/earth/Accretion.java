...
public class Accretion extends EarthAbility implements AddonAbility {
	...
	public Accretion(Player player) {
		...
		this.shot = false;
		this.damage = AvatarDuels.instance.getConfig().getDouble("Abilities.Earth.Accretion.Damage");
		this.blocks = AvatarDuels.instance.getConfig().getInt("Abilities.Earth.Accretion.Blocks");
		this.selectRange = AvatarDuels.instance.getConfig().getInt("Abilities.Earth.Accretion.SelectRange");
		this.revertTime = AvatarDuels.instance.getConfig().getLong("Abilities.Earth.Accretion.RevertTime");
		this.cooldown = AvatarDuels.instance.getConfig().getLong("Abilities.Earth.Accretion.Cooldown");
		this.throwSpeed = AvatarDuels.instance.getConfig().getDouble("Abilities.Earth.Accretion.ThrowSpeed");
	...
	public boolean isEnabled() {
		return AvatarDuels.instance.getConfig().getBoolean("Abilities.Earth.Accretion.Enabled");
	}
