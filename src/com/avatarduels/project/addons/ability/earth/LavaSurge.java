package com.avatarduels.project.addons.ability.earth;
...
import com.avatarduels.project.addons.util.AnimationBuilder;
...
public class LavaSurge extends LavaAbility implements AddonAbility {
	...
	public LavaSurge(Player player) {
		...
		this.cooldown = AvatarDuels.instance.getConfig().getLong("Abilities.Earth.LavaSurge.Cooldown");
		this.damage = AvatarDuels.instance.getConfig().getDouble("Abilities.Earth.LavaSurge.Damage");
		this.burn = AvatarDuels.instance.getConfig().getBoolean("Abilities.Earth.LavaSurge.Burn.Enabled");
		this.burnTime = AvatarDuels.instance.getConfig().getLong("Abilities.Earth.LavaSurge.Burn.Duration");
		this.speed = AvatarDuels.instance.getConfig().getDouble("Abilities.Earth.LavaSurge.Speed");
		this.sourceRadius = AvatarDuels.instance.getConfig().getDouble("Abilities.Earth.LavaSurge.SourceRadius");
		this.selectRange = AvatarDuels.instance.getConfig().getInt("Abilities.Earth.LavaSurge.SelectRange");
		this.maxBlocks = AvatarDuels.instance.getConfig().getInt("Abilities.Earth.LavaSurge.MaxBlocks");
		this.shot = false;
		this.shotBlocks = 0;
	...
	public void progress() {
		...
		if (shot) {
			if (!launchedAll && shotBlocks < maxBlocks) {
				...
				fb.setMetadata("lavasurge", new FixedMetadataValue(AvatarDuels.instance, this));
				fb.setVelocity(v);
	...
	public boolean isEnabled() {
		return AvatarDuels.instance.getConfig().getBoolean("Abilities.Earth.LavaSurge.Enabled");
	}
