...
import com.avatarduels.project.addons.util.SoundEffect;
...
public class MagmaSlap extends LavaAbility implements AddonAbility {
	...
	private void setFields() {
		this.offset = AvatarDuels.instance.getConfig().getDouble("Abilities.Earth.MagmaSlap.Offset");
		this.damage = AvatarDuels.instance.getConfig().getDouble("Abilities.Earth.MagmaSlap.Damage");
		this.length = 0;
		this.maxLength = AvatarDuels.instance.getConfig().getInt("Abilities.Earth.MagmaSlap.Length");
		this.width = AvatarDuels.instance.getConfig().getInt("Abilities.Earth.MagmaSlap.Width");
		this.next = 50;
		this.last = 0;
		this.revertTime = AvatarDuels.instance.getConfig().getLong("Abilities.Earth.MagmaSlap.RevertTime");
	...
	public long getCooldown() {
		return AvatarDuels.instance.getConfig().getLong("Abilities.Earth.MagmaSlap.Cooldown");
	}
	...
	public boolean isEnabled() {
		return AvatarDuels.instance.getConfig().getBoolean("Abilities.Earth.MagmaSlap.Enabled");
	}
}
