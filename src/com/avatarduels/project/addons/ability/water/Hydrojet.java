...
public class Hydrojet extends WaterAbility implements AddonAbility, PassiveAbility {
	...
	public Hydrojet(Player player) {
		...
		amp = AvatarDuels.instance.getConfig().getInt("Passives.Water.Hydrojet.Speed");
	...
	public boolean isEnabled() {
		return AvatarDuels.instance.getConfig().getBoolean("Passives.Water.Hydrojet.Enabled");
	}
