...
public class Dig extends EarthAbility implements AddonAbility {
	...
	public Dig(Player player) {
		...
		this.cooldown = AvatarDuels.instance.getConfig().getLong("Abilities.Earth.Dig.Cooldown");
		this.duration = AvatarDuels.instance.getConfig().getLong("Abilities.Earth.Dig.Duration");
		this.revertTime = AvatarDuels.instance.getConfig().getLong("Abilities.Earth.Dig.RevertTime");
		this.speed = AvatarDuels.instance.getConfig().getDouble("Abilities.Earth.Dig.Speed");
	...
	public boolean isEnabled() {
		return AvatarDuels.instance.getConfig().getBoolean("Abilities.Earth.Dig.Enabled");
	}
	
	@Override
	public String getDescription() {
		return "Swim through the earth, digging a path with your earth. Inspired by toph's learning from the badgermoles! You must also be looking at an earthbendable block for the ability to work!";
	}
