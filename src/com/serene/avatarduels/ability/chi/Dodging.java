...
public class Dodging extends ChiAbility implements AddonAbility, PassiveAbility {
	...
	public Dodging(Player player) {
		...
		chance = AvatarDuels.instance.getConfig().getDouble("Passives.Chi.Dodging.Chance") / 100;
	}
	...
	public boolean isEnabled() {
		return AvatarDuels.instance.getConfig().getBoolean("Passives.Chi.Dodging.Enabled");
	}
