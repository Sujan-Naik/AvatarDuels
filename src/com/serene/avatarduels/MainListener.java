...
import com.serene.avatarduels.ability.air.Deafen;
import com.serene.avatarduels.ability.air.FlightPassive;
import com.serene.avatarduels.ability.air.GaleGust;
import com.serene.avatarduels.ability.air.SonicWave;
import com.serene.avatarduels.ability.air.VocalMimicry;
import com.serene.avatarduels.ability.air.Zephyr;
import com.serene.avatarduels.ability.avatar.EnergyBeam;
import com.serene.avatarduels.ability.avatar.EnergyBeam.EnergyColor;
import com.serene.avatarduels.ability.chi.Dodging;
import com.serene.avatarduels.ability.chi.Jab;
import com.serene.avatarduels.ability.chi.Jab.JabHand;
import com.serene.avatarduels.ability.chi.NinjaStance;
import com.serene.avatarduels.ability.chi.WeakeningJab;
import com.serene.avatarduels.ability.earth.Accretion;
import com.serene.avatarduels.ability.earth.Bulwark;
import com.serene.avatarduels.ability.earth.Crumble;
import com.serene.avatarduels.ability.earth.Dig;
import com.serene.avatarduels.ability.earth.EarthKick;
import com.serene.avatarduels.ability.earth.LavaSurge;
import com.serene.avatarduels.ability.earth.MagmaSlap;
import com.serene.avatarduels.ability.earth.QuickWeld;
import com.serene.avatarduels.ability.earth.ShrapnelBlast;
import com.serene.avatarduels.ability.earth.ShrapnelShot;
import com.serene.avatarduels.ability.fire.ArcSpark;
import com.serene.avatarduels.ability.fire.ChargeBolt;
import com.serene.avatarduels.ability.fire.CombustBeam;
import com.serene.avatarduels.ability.fire.Electrify;
import com.serene.avatarduels.ability.fire.Explode;
import com.serene.avatarduels.ability.fire.FireDisc;
import com.serene.avatarduels.ability.fire.Jets;
import com.serene.avatarduels.ability.water.BloodGrip;
import com.serene.avatarduels.ability.water.MistShards;
import com.serene.avatarduels.ability.water.PlantArmor;
import com.serene.avatarduels.ability.water.RazorLeaf;
import com.serene.avatarduels.util.BendingPredicate;
...
public class MainListener implements Listener {
	...
	public void onChat(AsyncPlayerChatEvent event) {
		...
		if (args[0].equalsIgnoreCase("@energycolor")) {
			if (!player.hasPermission(".ability.energybeam")) {
			...
			if (!player.hasPermission(".ability.VocalMimicry")) {
	...
	public void onReload(BendingReloadEvent event) {
		...
		new BukkitRunnable() {
			@Override
			public void run() {
				CoreAbility.registerPluginAbilities(plugin, "com.serene.avatarduels.addons.ability");
			}
	...
	public void onOffhandToggle(PlayerSwapHandItemsEvent event) {
		...
		if (player.hasPermission(".offhandswap")) {
			if (MultiAbilityManager.hasMultiAbilityBound(player)) {
				return;
			}
