...
public class Corrupt extends WaterAbility {
    ...
    public void setFields() {
        ...
        this.cooldown = config.getLong("Abilities.Spirits.Water.Corrupt.Cooldown");
        this.duration = config.getLong("Abilities.Spirits.Water.Corrupt.Duration");
        this.range = config.getDouble("Abilities.Spirits.Water.Corrupt.Range");
        this.setElement = config.getBoolean("Abilities.Spirits.Water.Corrupt.SetElement");
    }
