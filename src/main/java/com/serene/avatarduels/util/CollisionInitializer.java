    ...
    public boolean initialize() {
        ...
        for (String key : section.getKeys(false)) {
            ...
            if (key.equalsIgnoreCase("-small-")) {
                AvatarDuels.logDebug("Initializing small collision for " + abilityName + ".");
                ProjectKorra.getCollisionInitializer().addSmallAbility(ability);

                continue;
            } else if (key.equalsIgnoreCase("-large-")) {
                AvatarDuels.logDebug("Initializing large collision for " + abilityName + ".");
            ...
            if (secondAbility != null) {
                AvatarDuels.logDebug("Initializing collision for " + abilityName + " => " + key);
