...
public class AvatarDuelsConfig {
	...
	private void loadConfigCore() {
		FileConfiguration config;
		config = AvatarDuels.plugin.getConfig();
		...
		config.addDefault("Abilities.Water.Blood.Enabled", true);
		config.addDefault("Abilities.Water.Blood.Description", "This ability allows a skilled waterbender "
		...
		config.addDefault("Abilities.Water.Blood.NightOnly", false);
		config.addDefault("Abilities.Water.Blood.FullMoonOnly", false);
		config.addDefault("Abilities.Water.Blood.UndeadMobs", true);
		config.addDefault("Abilities.Water.Blood.IgnoreWalls", false);
		config.addDefault("Abilities.Water.Blood.RequireBound", false);
		config.addDefault("Abilities.Water.Blood.Distance", 6);
		config.addDefault("Abilities.Water.Blood.HoldTime", 10000);
		config.addDefault("Abilities.Water.Blood.Cooldown", 4000);
