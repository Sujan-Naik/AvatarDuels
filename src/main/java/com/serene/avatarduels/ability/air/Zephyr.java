...
public class Zephyr extends AirAbility implements AddonAbility {
	...
	public Zephyr(Player player) {
		...
		this.radius = AvatarDuels.getConfig(getName()).getDouble("Abilities.Air.Zephyr.Radius");
		this.cooldown = AvatarDuels.getConfig(getName()).getLong("Abilities.Air.Zephyr.Cooldown");
	...
	public boolean isEnabled() {
		return AvatarDuels.getConfig(getName()).getBoolean("Abilities.Air.Zephyr.Enabled");
	}
