...
public class SonicWave extends SoundAbility implements AddonAbility {
	...
	public SonicWave(Player player) {
		...
		this.width = AvatarDuels.getConfig(getName()).getDouble("Abilities.Air.SonicWave.Width");
		this.duration = AvatarDuels.getConfig(getName()).getInt("Abilities.Air.SonicWave.Nausea.Duration");
		this.amp = AvatarDuels.getConfig(getName()).getInt("Abilities.Air.SonicWave.Nausea.Power") + 1;
		this.cooldown = AvatarDuels.getConfig(getName()).getLong("Abilities.Air.SonicWave.Cooldown");
		this.maxRange = AvatarDuels.getConfig(getName()).getDouble("Abilities.Air.SonicWave.Range");
		this.range = 0;
	...
	public boolean isEnabled() {
		return AvatarDuels.getConfig(getName()).getBoolean("Abilities.Air.SonicWave.Enabled");
	}
}
