...
public class ChargeBolt extends LightningAbility implements AddonAbility {
	...
	public ChargeBolt(Player player) {
		...
		chargeTime = AvatarDuels.getConfig(getName()).getLong("Abilities.Fire.ChargeBolt.ChargeTime");
		damage = AvatarDuels.getConfig(getName()).getDouble("Abilities.Fire.ChargeBolt.Damage");
		boltRange = AvatarDuels.getConfig(getName()).getDouble("Abilities.Fire.ChargeBolt.BoltRange");
		blastRadius = AvatarDuels.getConfig(getName()).getDouble("Abilities.Fire.ChargeBolt.BlastRadius");
		speed = AvatarDuels.getConfig(getName()).getInt("Abilities.Fire.ChargeBolt.Speed");
		cooldown = AvatarDuels.getConfig(getName()).getLong("Abilities.Fire.ChargeBolt.Cooldown");
		dischargeBolts = AvatarDuels.getConfig(getName()).getInt("Abilities.Fire.ChargeBolt.DischargeBoltCount");
	...
	public boolean isEnabled() {
		return AvatarDuels.getConfig(getName()).getBoolean("Abilities.Fire.ChargeBolt.Enabled");
	}
