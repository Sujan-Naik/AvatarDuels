...
public class NinjaStance extends ChiAbility implements AddonAbility{
	...
	public NinjaStance(Player player) {
		...
		stealthDuration = AvatarDuels.getConfig(getName()).getLong("Abilities.Chi.NinjaStance.Stealth.Duration");
		stealthChargeTime = AvatarDuels.getConfig(getName()).getLong("Abilities.Chi.NinjaStance.Stealth.ChargeTime");
		stealthCooldown = AvatarDuels.getConfig(getName()).getLong("Abilities.Chi.NinjaStance.Stealth.Cooldown");
		effects.add(new PotionEffect(PotionEffectType.SPEED, 5, AvatarDuels.getConfig(getName()).getInt("Abilities.Chi.NinjaStance.SpeedAmplifier") + 1, true, false));
		effects.add(new PotionEffect(PotionEffectType.JUMP_BOOST, 5, AvatarDuels.getConfig(getName()).getInt("Abilities.Chi.NinjaStance.JumpAmplifier") + 1, true, false));
	...
	public long getCooldown() {
		return AvatarDuels.getConfig(getName()).getLong("Abilities.Chi.NinjaStance.Cooldown");
	}
	...
	public boolean isEnabled() {
		return AvatarDuels.getConfig(getName()).getBoolean("Abilities.Chi.NinjaStance.Enabled");
	}
	...
	public static double getDamageModifier() {
		return AvatarDuels.getConfig("NinjaStance").getDouble("Abilities.Chi.NinjaStance.DamageModifier");
	}
}
