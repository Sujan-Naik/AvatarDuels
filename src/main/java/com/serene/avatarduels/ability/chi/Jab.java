...
public class Jab extends ChiAbility implements AddonAbility{
	...
	public Jab(Player player, Entity entity, JabHand hand) {
		...
		cooldown = AvatarDuels.getConfig(getName()).getLong("Abilities.Chi.Jab.Cooldown");
		maxUses = AvatarDuels.getConfig(getName()).getInt("Abilities.Chi.Jab.MaxUses");
	...
	public boolean isEnabled() {
		return AvatarDuels.getConfig(getName()).getBoolean("Abilities.Chi.Jab.Enabled");
	}
}
