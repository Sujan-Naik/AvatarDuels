...
public class FlyingKick extends ChiAbility implements ComboAbility, AddonAbility {
	...
	public FlyingKick(Player player) {
		...
		launch = AvatarDuels.getConfig(getName()).getDouble("Combos.Chi.FlyingKick.LaunchPower");
		damage = AvatarDuels.getConfig(getName()).getDouble("Combos.Chi.FlyingKick.Damage");
		cooldown = AvatarDuels.getConfig(getName()).getLong("Combos.Chi.FlyingKick.Cooldown");
	...
	public boolean isEnabled() {
		return AvatarDuels.getConfig(getName()).getBoolean("Combos.Chi.FlyingKick.Enabled");
	}
}
