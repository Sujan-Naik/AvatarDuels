...
public class WaterFlow extends WaterAbility implements AddonAbility, ComboAbility {
	...
	public ArrayList<AbilityInformation> getCombination() {
		return ComboUtil.generateCombinationFromList(this, AvatarDuelsConfig.getConfig(player).getStringList("Abilities.Water.WaterCombo.WaterFlow.Combination"));
	}

	@Override
	public String getInstructions() {
		return AvatarDuelsConfig.getConfig(player).getString("Abilities.Water.WaterCombo.WaterFlow.Instructions");
	}
