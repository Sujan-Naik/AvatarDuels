...
public class MistShards extends IceAbility implements AddonAbility, ComboAbility {
	...
	public MistShards(Player player) {
		...
		this.cooldown = AvatarDuels.getConfig(getName()).getLong("Combos.Water.MistShards.Cooldown");
		this.damage = AvatarDuels.getConfig(getName()).getDouble("Combos.Water.MistShards.Damage");
		this.range = AvatarDuels.getConfig(getName()).getDouble("Combos.Water.MistShards.Range");
		this.icicleCount = AvatarDuels.getConfig(getName()).getInt("Combos.Water.MistShards.IcicleCount");
	...
	public boolean isEnabled() {
		return AvatarDuels.getConfig(getName()).getBoolean("Combos.Water.MistShards.Enabled");
	}
