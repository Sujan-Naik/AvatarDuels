...
public class PlantArmor extends PlantAbility implements AddonAbility, MultiAbility {
	...
	public PlantArmor(Player player, ClickType type) {
		...
		if (type == ClickType.SHIFT_DOWN) {
			this.duration = AvatarDuels.getConfig(getName()).getLong("Abilities.Water.PlantArmor.Duration");
			this.cooldown = AvatarDuels.getConfig(getName()).getLong("Abilities.Water.PlantArmor.Cooldown");
			this.durability = this.maxDurability = AvatarDuels.getConfig(getName()).getDouble("Abilities.Water.PlantArmor.Durability");
			this.duration = AvatarDuels.getConfig(getName()).getLong("Abilities.Water.PlantArmor.Duration");
			this.durabilityDecay = duration <= 0 ? 0 : maxDurability / (20.0 * duration / 1000.0);
			this.swim = AvatarDuels.getConfig(getName()).getInt("Abilities.Water.PlantArmor.Boost.Swim") - 1;
			this.speed = AvatarDuels.getConfig(getName()).getInt("Abilities.Water.PlantArmor.Boost.Speed") - 1;
			this.jump = AvatarDuels.getConfig(getName()).getInt("Abilities.Water.PlantArmor.Boost.Jump") - 1;
			this.armor = null;
			...
			this.requiredPlants = AvatarDuels.getConfig(getName()).getInt("Abilities.Water.PlantArmor.RequiredPlants");
			this.selectRange = AvatarDuels.getConfig(getName()).getDouble("Abilities.Water.PlantArmor.SelectRange");
			
			this.forward = true;
			this.range = 0;
			this.maxRange = AvatarDuels.getConfig(getName()).getInt("Abilities.Water.PlantArmor.SubAbilities.VineWhip.Range");
			this.vdmg = AvatarDuels.getConfig(getName()).getDouble("Abilities.Water.PlantArmor.SubAbilities.VineWhip.Damage");
			this.vSpeed = AvatarDuels.getConfig(getName()).getInt("Abilities.Water.PlantArmor.SubAbilities.VineWhip.Speed");
			
			this.radius = AvatarDuels.getConfig(getName()).getInt("Abilities.Water.PlantArmor.SubAbilities.LeafShield.Radius");
			
			this.current = null;
			this.tRadius = AvatarDuels.getConfig(getName()).getDouble("Abilities.Water.PlantArmor.SubAbilities.Tangle.Radius");
			this.tRange = AvatarDuels.getConfig(getName()).getDouble("Abilities.Water.PlantArmor.SubAbilities.Tangle.Range");
			this.tDuration = AvatarDuels.getConfig(getName()).getLong("Abilities.Water.PlantArmor.SubAbilities.Tangle.Duration");
			this.angle = 0;
			
			this.gMax = AvatarDuels.getConfig(getName()).getInt("Abilities.Water.PlantArmor.SubAbilities.Grapple.Range");
			this.gSpeed = AvatarDuels.getConfig(getName()).getDouble("Abilities.Water.PlantArmor.SubAbilities.Grapple.Speed");
			this.pulling = false;
			this.gRange = 0;
			
			this.dRadius = AvatarDuels.getConfig(getName()).getInt("Abilities.Water.PlantArmor.SubAbilities.LeafDome.Radius");
			
			this.power = AvatarDuels.getConfig(getName()).getDouble("Abilities.Water.PlantArmor.SubAbilities.Leap.Power");
			
			this.regen = AvatarDuels.getConfig(getName()).getInt("Abilities.Water.PlantArmor.SubAbilities.Regenerate.RegenAmount");
	...
	private void reset() {
		if (active != null) {
			bPlayer.addCooldown(active.getName(), AvatarDuels.getConfig(getName()).getLong("Abilities.Water.PlantArmor.SubAbilities." + active.getName() + ".Cooldown"));
	...
	private int getAbilityCost(String ability) {
		return AvatarDuels.getConfig(getName()).getInt("Abilities.Water.PlantArmor.SubAbilities." + ability + ".Cost");
	}
	...
	public boolean isEnabled() {
		return AvatarDuels.getConfig(getName()).getBoolean("Abilities.Water.PlantArmor.Enabled");
	}
