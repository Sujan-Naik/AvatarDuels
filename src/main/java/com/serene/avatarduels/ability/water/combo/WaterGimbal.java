package com.serene.avatarduels.ability.water.combo;

import com.serene.avatarduels.JCMethods;
import com.serene.avatarduels.AvatarDuels;
import com.serene.avatarduels.ability.water.WaterBlast;
import com.serene.avatarduels.configuration.AvatarDuelsConfig;
import com.serene.avatarduels.util.CollisionInitializer;
...
public class WaterGimbal extends WaterAbility implements AddonAbility, ComboAbility {
	...
	private boolean hasWaterBottle(Player player) {
		...
		return AvatarDuels.plugin.getPotionEffectAdapter().hasWaterPotion(inventory);
	}
	...
	public ArrayList<AbilityInformation> getCombination() {
		return ComboUtil.generateCombinationFromList(this, AvatarDuelsConfig.getConfig(player).getStringList("Abilities.Water.WaterCombo.WaterGimbal.Combination"));
	}

	@Override
	public String getInstructions() {
		return AvatarDuelsConfig.getConfig(player).getString("Abilities.Water.WaterCombo.WaterGimbal.Instructions");
	}
