...
public class Bloodbending extends BloodAbility implements AddonAbility {
	...
	public void setFields() {
		...
		undeadMobs = config.getBoolean("Abilities.Water.Blood.UndeadMobs");
		bloodbendingThroughBlocks = config.getBoolean("Abilities.Water.Blood.IgnoreWalls");
		requireBound = config.getBoolean("Abilities.Water.Blood.RequireBound");
		distance = config.getInt("Abilities.Water.Blood.Distance");
		holdTime = config.getLong("Abilities.Water.Blood.HoldTime");
		cooldown = config.getLong("Abilities.Water.Blood.Cooldown");
	}
