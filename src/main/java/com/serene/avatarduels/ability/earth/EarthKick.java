...
public class EarthKick extends EarthAbility implements AddonAbility, Listener{
	...
	public void setFields() {
		damage = AvatarDuels.getConfig(getName()).getDouble("Abilities.Earth.EarthKick.Damage");
		maxBlocks = AvatarDuels.getConfig(getName()).getInt("Abilities.Earth.EarthKick.MaxBlocks");
		lavaMult = AvatarDuels.getConfig(getName()).getDouble("Abilities.Earth.EarthKick.LavaMultiplier");
		kick = new ArrayList<>();
	}
	...
	public long getCooldown() {
		return AvatarDuels.getConfig(getName()).getLong("Abilities.Earth.EarthKick.Cooldown");
	}
	...
	public boolean isEnabled() {
		return AvatarDuels.getConfig(getName()).getBoolean("Abilities.Earth.EarthKick.Enabled");
	}
}
