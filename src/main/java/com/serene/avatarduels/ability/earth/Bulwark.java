...
public class Bulwark extends EarthAbility implements AddonAbility {
	...
	public Bulwark(Player player) {
		...
		this.cooldown = AvatarDuels.getConfig(getName()).getLong("Abilities.Earth.Bulwark.Cooldown");
		this.damage = AvatarDuels.getConfig(getName()).getDouble("Abilities.Earth.Bulwark.Damage");
		this.throwSpeed = AvatarDuels.getConfig(getName()).getDouble("Abilities.Earth.Bulwark.ThrowSpeed");
		this.height = AvatarDuels.getConfig(getName()).getInt("Abilities.Earth.Bulwark.Height");
	...
	public void clickFunction() {
		...
		for (Block b : blocks) {
			...
			fb.setMetadata("bulwark", new FixedMetadataValue(AvatarDuels.instance, this));
	...
	public boolean isEnabled() {
		return AvatarDuels.getConfig(getName()).getBoolean("Abilities.Earth.Bulwark.Enabled");
	}
}
