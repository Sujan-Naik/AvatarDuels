...
public class ShrapnelShot extends MetalAbility implements AddonAbility {
	...
	public ShrapnelShot(Player player) {
		...
		this.speed = AvatarDuels.getConfig(getName()).getDouble("Abilities.Earth.Shrapnel.Shot.Speed");
		this.damage = AvatarDuels.getConfig(getName()).getDouble("Abilities.Earth.Shrapnel.Shot.Damage");
		this.cooldown = AvatarDuels.getConfig(getName()).getLong("Abilities.Earth.Shrapnel.Shot.Cooldown");
	...
	public boolean isEnabled() {
		return AvatarDuels.getConfig(getName()).getBoolean("Abilities.Earth.Shrapnel.Enabled");
	}
}
